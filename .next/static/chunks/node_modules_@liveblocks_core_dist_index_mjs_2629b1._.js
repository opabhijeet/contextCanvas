(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_@liveblocks_core_dist_index_mjs_2629b1._.js", {

"[project]/node_modules/@liveblocks/core/dist/index.mjs [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var Batch = class {
    ...
    get(input) {
        const existingCall = this.#queue.find((call2)=>stringify(call2.input) === stringify(input));
        if (existingCall) {
...
function url(strings, ...values) {
    return strings.reduce((result, str, i)=>result + encodeURIComponent(values[i - 1] ?? "") + str);
}
// src/api-client.ts
...
//# sourceMappingURL=node_modules_%40liveblocks_core_dist_index_mjs_2629b1._.js.map